      ...
      body: Obx(() {
        return Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                if (controller.alreadySolved.value)
                  const Center(
                    child: Padding(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        CircleAvatar(
                          radius: 14,
                          backgroundImage: q.creatorAvatarUrl.isNotEmpty
                              ? NetworkImage(q.creatorAvatarUrl)
                    ...
                    ...q.choices.map(
                      (choice) => Obx(() {
                        final isSelected = controller.selected.value == choice;
